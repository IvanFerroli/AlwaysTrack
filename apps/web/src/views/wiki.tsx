...
function WikiReviewSnapshot({ label, version, content, emptyDetail }: { label: string; version?: number; content?: string; emptyDetail?: string }) {
  return (
    <div className="wiki-review-snapshot">
      ...
      {content ? <MarkdownContent content={content} /> : <OperationalState state="empty" title={emptyDetail ?? "Conteudo indisponivel"} />}
    </div>
  );
}
        ...
        <section className="panel form-panel">
          ...
          <form onSubmit={createPage}>
            <div className="form-grid">
              ...
              <div className="full-span">
                <MarkdownEditor label="Conteudo" rows={6} value={content} onChange={setContent} onUploadImage={(file) => uploadWikiImage(file)} />
              </div>
            </div>
            ...
            <>
                ...
                <div className="wiki-compare-panel">
                  ...
                  <div className="wiki-compare-grid">
                    <div>
                      ...
                      <MarkdownContent content={comparedRevision.content} />
                    </div>
                    <div>
              ...
              {selected.active ? (
                <form className="wiki-edit-form" onSubmit={user.role === "ADMIN" ? publishEdit : requestEdit}>
                  ...
                  <MarkdownEditor label="Conteudo" value={editContent} onChange={setEditContent} onUploadImage={(file) => uploadWikiImage(file, selected.id)} />
                  <div className="form-actions">
