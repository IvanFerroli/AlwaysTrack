  ...
  test: {
    ...
    coverage: {
      ...
      thresholds: {
        ...
        "src/views/case-flow/admin/index.tsx": { statements: 95, lines: 95, branches: 90, functions: 95 },
        "src/views/case-flow/health.tsx": { statements: 95, lines: 95, branches: 90, functions: 95 },
        "src/views/dashboard.tsx": { statements: 95, lines: 95, branches: 85, functions: 90 },
