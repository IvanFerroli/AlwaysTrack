...
const service = vi.hoisted(() => ({
  ...
  listOperationalUserOptions: vi.fn(),
...
describe("user management HTTP handlers", () => {
  beforeEach(() => {
    ...
    for (const mock of [
      ...
      service.listOperationalUserOptions,
  ...
  it.each([
    ...
    ["list operational options", listOperationalUserOptionsHandler, service.listOperationalUserOptions, "get", "/v1/users/operational-options", "/v1/users/operational-options", undefined, 200],
