...
export const commercialPermissionMatrix = {
  ...
  "supportSchedule.read": supportOperationsRoles,
  "supportSchedule.manage": commercialManagerRoles,
  "supportSchedule.exchange": supportOperationsRoles,
  "supportSchedule.approve": commercialManagerRoles,
