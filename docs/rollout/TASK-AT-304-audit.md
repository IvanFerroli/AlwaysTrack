...
| Loggi read-only por `EvidenceFact` | AT-269 fixture; runtime AT-270 | implementacao concluida, gate live pendente | `PENDENTE_LIVE` |
| J&T com pausa em captcha | AT-271 fixture; runtime AT-272 | implementacao concluida, gate live pendente | `PENDENTE_LIVE` |
| Correios/Reversa com pausa em 2FA | AT-273 fixture; runtime AT-274 | implementacao concluida, gate live pendente | `PENDENTE_LIVE` |
