...
- Filtros de tags/skills, local, fonte e status viraram multi-select.
- Opcoes dos filtros sao derivadas das vagas carregadas no batch atual.
- Tags/skills, local, fonte e status multi-select aplicam OR dentro da categoria.
...
- O componente de dropdown compacto exigiu hardening de acessibilidade e sanitizacao para evitar risco de regressao/XSS.
