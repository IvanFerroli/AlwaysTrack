# TASK-AT-320 - Dados: integracao production-like de Postgres, Redis e storage

## Metadata
- status: planned
- owner: olympus_taskyfier
- last-updated: 2026-07-15
- source-of-truth: docs/tasks/TASK-AT-320-production-like-data-integration-tests.md
...
## Objetivo unico
Provar migracoes, concorrencia, filas e storage contra dependencias equivalentes as de producao.
...
- em aberto: TASK-AT-149, TASK-AT-150, TASK-AT-310.

## Alvos explicitos
1. tests/integration/infrastructure/**
2. .github/workflows/check.yml
3. deploy/docker-compose.example.yml
...
1. Executar Postgres real com migrations, constraints e concorrencia.
2. Cobrir Redis/BullMQ em restart, dedupe, poison job, retry e indisponibilidade.
3. Cobrir storage compativel com S3, upload, download, delete e falha parcial.

## Acceptance Criteria
1. SQLite e mocks nao sao usados como unica evidencia desta suite.
2. Falhas de dependencia possuem comportamento deterministico e observavel.
3. Dados e recursos temporarios sao isolados e removidos ao final.
...
## Riscos
- CI lento ou flakey por servicos externos mal isolados.
