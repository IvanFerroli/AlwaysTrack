...
## Objetivo unico
Padronizar scripts e um gate raiz que valide fonte e artefatos compilados de todos os workspaces.
...
1. Definir scripts obrigatorios e excecoes justificadas por tipo de workspace.
2. Executar lint, typecheck, testes e build sem omissao silenciosa.
3. Validar MV3, entrypoints dist e bundles Web/API no CI.

## Acceptance Criteria
1. Cada workspace cumpre o contrato ou declara excecao verificavel.
2. O CI compila todos os artefatos implantaveis.
3. Falha de build ou suite ausente bloqueia o gate.
...
## Riscos
- Aumentar demais o tempo de feedback do gate rapido.
