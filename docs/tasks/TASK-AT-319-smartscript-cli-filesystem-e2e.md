...
## Objetivo unico
Cobrir o ciclo start, status, process, import, export e falhas em diretorio temporario sem tocar dados reais.
...
- em aberto: TASK-AT-190, TASK-AT-192, TASK-AT-310.

## Alvos explicitos
1. apps/smartscript-companion/src/**/*.test.ts
2. apps/smartscript-companion/fixtures/**
3. docs/runbooks/RUNBOOK-004-smartscript-local-companion.md
...
1. Simular API, filesystem e instalacao Espanso autorizada.
2. Cobrir idempotencia, arquivos corrompidos, indisponibilidade e cleanup.
3. Reexecutar regressao de privacidade e redaction.

## Acceptance Criteria
1. Todos os comandos principais possuem caminho feliz e falha testados.
2. Teste nao escreve na configuracao real do operador.
3. Nenhum payload ou segredo aparece em logs e artefatos.
...
## Riscos
- Teste alterar configuracao local do Espanso por engano.
