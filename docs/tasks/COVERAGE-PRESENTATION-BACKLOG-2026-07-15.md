...
| --- | ---: | ---: | ---: | --- |
| Web | 33.08% | 68.52% | 41.71% | conteudo e Fluxos cobertos; ampliar CaseFlow operacional |
...
5. TASK-AT-341: Web operacional, Fluxos e CaseFlow em 30%. Em andamento; marco de linhas atingido, funcoes pendentes.
