...
## Objetivo unico
Detectar links quebrados, comandos obsoletos, metadata ausente e divergencia de status automaticamente.
...
- em aberto: TASK-AT-308, TASK-AT-299.
...
1. Validar links e paths internos, anchors, comandos e referencias de task.
2. Comparar scripts documentados com package manifests.
3. Reconciliar rollout e backlog com ledger canonico.

## Acceptance Criteria
1. check:docs falha em referencia quebrada ou comando inexistente.
2. Docs de rollout refletem os statuses atuais sem alterar o NO-GO indevidamente.
3. Excecoes documentais possuem justificativa e owner.
...
## Riscos
- Scanner gerar ruido em arquivos historicos arquivados.
